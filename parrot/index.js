...
app.get('/', function (req, res) {
    res.send('Hello world, I am a siNUsoid')
})

// for Facebook verification
app.get('/webhook/', function (req, res) {
    if (req.query['hub.verify_token'] === 'siNUsoid - NIIT University') {
...
// API End Point - added by GeekyShiva
...
// function to echo back messages - added by GeekyShiva
